...
public class OneselectPiechartActivity extends AppCompatActivity {
...
//    private TextView mT6;
    ...
    public void connectionselectresult(int id) {
        String url = address.HOST+"/andriod/selectoneselectanswer";
    ...
    private void initView() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                OneselectPiechartActivity.this.finish();
            }
        });
