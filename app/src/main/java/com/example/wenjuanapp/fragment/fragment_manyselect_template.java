...
public class fragment_manyselect_template extends Fragment {
    private View view;
   ...
   // private  int i=1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        project_id=(((TemplateQuestionView)getActivity()).getID());
        return  view;
    }
    ...
    public void connectiongetview(int id) {
        String url = address.HOST+"/andriod/selecttemplatemanyselect";
