...
import com.example.wenjuanapp.removequestion.ManyselectActivity;
import com.example.wenjuanapp.removequestion.OneselectActivity;
import com.example.wenjuanapp.utils.HttpUtil;
import com.example.wenjuanapp.utils.address;
import com.example.wenjuanapp.vo.ManyselectVO;
...
public class fragment_mangselect extends Fragment {
    private View view;
    private List<ManyselectVO> datalist = new ArrayList<ManyselectVO>();
    public ListView lv;
  ...
  //  private  int i=1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        view=inflater.inflate(R.layout.fragment_mangselect,container,false);
        project_name=(((ProjectQuestionActivity)getActivity()).getName1());
        return  view;
    }
    ...
    private void initView() {
        list.clear();
        this.lv=(ListView)getActivity().findViewById(R.id.project_manyselect_list_view);
    ...
    public void connectiongetview(int id) {
        String url = address.HOST+"/andriod/selectmanyselectbyprojectid";
        RequestParams params = new RequestParams(); // 绑定参数
                ...
                if (statusCode == 200) {
                    try {
                        ...
                        for (int i = 0 ; i < response.length() ;i++){
                            ...
                            ManyselectVO manyselectVO = new ManyselectVO(question_id,project_id,question_name,option_a,option_b,option_c,option_d);
                            datalist.add(manyselectVO);
                        }
           ...
           // i=i+1;
            ...
            click.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(getContext(),ManyselectActivity.class);
