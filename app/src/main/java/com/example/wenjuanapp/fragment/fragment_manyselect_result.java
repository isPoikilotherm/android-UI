...
import com.example.wenjuanapp.Piechart.ManyselectPiechartActivity;
...
public class fragment_manyselect_result extends Fragment {
    private View view;
          ...
          //  i=i+1;
            ...
            click.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(getContext(),ManyselectPiechartActivity.class);
