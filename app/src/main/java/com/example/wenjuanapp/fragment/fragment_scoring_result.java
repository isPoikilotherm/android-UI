...
import com.example.wenjuanapp.Piechart.ScoringPiechartActivity;
...
import com.example.wenjuanapp.removequestion.ScoringActivity;
...
public class fragment_scoring_result extends Fragment {
    private View view;
   ...
   // private  int i=1;
    ...
    public void connectiongetview(int id) {
        String url = address.HOST+"/andriod/selectscoringbyprojectid";
        RequestParams params = new RequestParams(); // 绑定参数
         ...
         //   i=i+1;
            ...
            click.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(getContext(),ScoringPiechartActivity.class);
