...
public class ScoringActivity extends Activity {
    ...
    private String old_scoring_name;
    private String new_scoring_name;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        old_scoring_name=intent.getStringExtra("name");
    ...
    scoring_name=(EditText)findViewById(R.id.remove_scoring_name);

    scoring_name.setText(old_scoring_name);


        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(ScoringActivity.this)
                        .setTitle("是否删除")
                        .setMessage("是否删除该问题？")
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ScoringActivity.this,ProjectQuestionActivity.class);
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new_scoring_name=scoring_name.getText().toString().trim();

                if (TextUtils.isEmpty(new_scoring_name)){
                    Toast.makeText(ScoringActivity.this,"请输入问题名称",
                            Toast.LENGTH_SHORT).show();
                }else {
                    connectionURL(question_id,new_scoring_name);
                }
    ...
    public void connectionURL(Integer question_id,String question_name){
        ...
        String url=address.HOST+"/andriod/updatescoring";
...
//
                            ...
                            Toast.makeText(ScoringActivity.this, "修改失败！", Toast.LENGTH_SHORT).show();
                        }
    ...
    public void connectiondeletequestion(int id) {
        String url = address.HOST+"/andriod/deletescoring";
        RequestParams params = new RequestParams(); // 绑定参数
                ...
                if (statusCode == 200) {
                    try {
                        ...
                        if(response.getBoolean("msg")==true){
                            ...
                            Toast.makeText(ScoringActivity.this, "删除失败！", Toast.LENGTH_SHORT).show();
                        }
