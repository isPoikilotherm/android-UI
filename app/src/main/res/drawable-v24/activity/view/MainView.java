 ...
 * 程序主入口
 */
public class MainView extends Activity implements ViewPager.OnPageChangeListener {
    ...
    private void initData() {
        // 图片资源id数组
        imageResIds = new int[]{R.drawable.a, R.drawable.b, R.drawable.c, R.drawable.d1,R.drawable.e};
