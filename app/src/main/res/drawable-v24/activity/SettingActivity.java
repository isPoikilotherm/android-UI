...
public class SettingActivity extends AppCompatActivity {
    ...
    public static com.example.wenjuan.feature.activity.SettingActivity instance = null;
    @Override
    ...
    private void init() {
        ...
        tv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                com.example.wenjuan.feature.activity.SettingActivity.this.finish();
            }
        });
        //修改密码的点击事件
        ...
        rl_exit_login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(com.example.wenjuan.feature.activity.SettingActivity.this, "退出登录成功",
